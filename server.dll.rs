...
pub mod CCSGameRules {
    ...
    pub const m_bSkipNextServerPerfSample: usize = 0x27B8;
}
...
pub mod CCSPlayerController {
    ...
    pub const m_iRoundsWon: usize = 0x824;
    ...
    pub const m_bJustDidTeamKill: usize = 0xF908;
    pub const m_bPunishForTeamKill: usize = 0xF909;
    pub const m_bGaveTeamDamageWarning: usize = 0xF90A;
    pub const m_bGaveTeamDamageWarningThisRound: usize = 0xF90B;
    pub const m_LastTeamDamageWarningTime: usize = 0xF90C;
}
...
pub mod CCSPlayerPawn {
    pub const m_pBulletServices: usize = 0x1548;
    pub const m_pHostageServices: usize = 0x1550;
    pub const m_pBuyServices: usize = 0x1558;
    pub const m_pActionTrackingServices: usize = 0x1560;
    pub const m_pRadioServices: usize = 0x1568;
    pub const m_pDamageReactServices: usize = 0x1570;
    pub const m_nCharacterDefIndex: usize = 0x1578;
    pub const m_hPreviousModel: usize = 0x1580;
    pub const m_bHasFemaleVoice: usize = 0x1588;
    pub const m_strVOPrefix: usize = 0x1590;
    pub const m_szLastPlaceName: usize = 0x1598;
    pub const m_bInBuyZone: usize = 0x1658;
    pub const m_bWasInBuyZone: usize = 0x1659;
    pub const m_bInHostageRescueZone: usize = 0x165A;
    pub const m_bInBombZone: usize = 0x165B;
    pub const m_bWasInHostageRescueZone: usize = 0x165C;
    pub const m_iRetakesOffering: usize = 0x1660;
    pub const m_iRetakesOfferingCard: usize = 0x1664;
    pub const m_bRetakesHasDefuseKit: usize = 0x1668;
    pub const m_bRetakesMVPLastRound: usize = 0x1669;
    pub const m_iRetakesMVPBoostItem: usize = 0x166C;
    pub const m_RetakesMVPBoostExtraUtility: usize = 0x1670;
    pub const m_flHealthShotBoostExpirationTime: usize = 0x1674;
    pub const m_flLandseconds: usize = 0x1678;
    pub const m_aimPunchAngle: usize = 0x167C;
    pub const m_aimPunchAngleVel: usize = 0x1688;
    pub const m_aimPunchTickBase: usize = 0x1694;
    pub const m_aimPunchTickFraction: usize = 0x1698;
    pub const m_aimPunchCache: usize = 0x16A0;
    pub const m_bIsBuyMenuOpen: usize = 0x16B8;
    pub const m_xLastHeadBoneTransform: usize = 0x1C10;
    pub const m_bLastHeadBoneTransformIsValid: usize = 0x1C30;
    pub const m_lastLandTime: usize = 0x1C34;
    pub const m_iPlayerLocked: usize = 0x1C38;
    pub const m_flTimeOfLastInjury: usize = 0x1C40;
    pub const m_flNextSprayDecalTime: usize = 0x1C44;
    pub const m_bNextSprayDecalTimeExpedited: usize = 0x1C48;
    pub const m_nRagdollDamageBone: usize = 0x1C4C;
    pub const m_vRagdollDamageForce: usize = 0x1C50;
    pub const m_vRagdollDamagePosition: usize = 0x1C5C;
    pub const m_szRagdollDamageWeaponName: usize = 0x1C68;
    pub const m_bRagdollDamageHeadshot: usize = 0x1CA8;
    pub const m_EconGloves: usize = 0x1CB0;
    pub const m_qDeathEyeAngles: usize = 0x1F28;
    pub const m_bSkipOneHeadConstraintUpdate: usize = 0x1F34;
}
...
pub mod CCSPlayerPawnBase {
    ...
    pub const m_bInvalidSteamLogonDelayed: usize = 0xD44;
    pub const m_flLastAction: usize = 0xD48;
    pub const m_flNameChangeHistory: usize = 0xD4C;
    pub const m_fLastGivenDefuserTime: usize = 0xD60;
    pub const m_fLastGivenBombTime: usize = 0xD64;
    pub const m_bHasNightVision: usize = 0xD68;
    pub const m_bNightVisionOn: usize = 0xD69;
    pub const m_fNextRadarUpdateTime: usize = 0xD6C;
    pub const m_flLastMoneyUpdateTime: usize = 0xD70;
    pub const m_MenuStringBuffer: usize = 0xD74;
    pub const m_fIntroCamTime: usize = 0x1174;
    pub const m_nMyCollisionGroup: usize = 0x1178;
    pub const m_bInNoDefuseArea: usize = 0x117C;
    pub const m_bKilledByTaser: usize = 0x117D;
    pub const m_iMoveState: usize = 0x1180;
    pub const m_grenadeParameterStashTime: usize = 0x1184;
    pub const m_bGrenadeParametersStashed: usize = 0x1188;
    pub const m_angStashedShootAngles: usize = 0x118C;
    pub const m_vecStashedGrenadeThrowPosition: usize = 0x1198;
    pub const m_vecStashedVelocity: usize = 0x11A4;
    pub const m_angShootAngleHistory: usize = 0x11B0;
    pub const m_vecThrowPositionHistory: usize = 0x11C8;
    pub const m_vecVelocityHistory: usize = 0x11E0;
    pub const m_bDiedAirborne: usize = 0x11F8;
    pub const m_iBombSiteIndex: usize = 0x11FC;
    pub const m_nWhichBombZone: usize = 0x1200;
    pub const m_bInBombZoneTrigger: usize = 0x1204;
    pub const m_bWasInBombZoneTrigger: usize = 0x1205;
    pub const m_iDirection: usize = 0x1208;
    pub const m_iShotsFired: usize = 0x120C;
    pub const m_ArmorValue: usize = 0x1210;
    pub const m_flFlinchStack: usize = 0x1214;
    pub const m_flVelocityModifier: usize = 0x1218;
    pub const m_flHitHeading: usize = 0x121C;
    pub const m_nHitBodyPart: usize = 0x1220;
    pub const m_iHostagesKilled: usize = 0x1224;
    pub const m_vecTotalBulletForce: usize = 0x1228;
    pub const m_flFlashDuration: usize = 0x1234;
    pub const m_flFlashMaxAlpha: usize = 0x1238;
    pub const m_flProgressBarStartTime: usize = 0x123C;
    pub const m_iProgressBarDuration: usize = 0x1240;
    pub const m_bWaitForNoAttack: usize = 0x1244;
    pub const m_flLowerBodyYawTarget: usize = 0x1248;
    pub const m_bStrafing: usize = 0x124C;
    pub const m_lastStandingPos: usize = 0x1250;
    pub const m_ignoreLadderJumpTime: usize = 0x125C;
    pub const m_ladderSurpressionTimer: usize = 0x1260;
    pub const m_lastLadderNormal: usize = 0x1278;
    pub const m_lastLadderPos: usize = 0x1284;
    pub const m_thirdPersonHeading: usize = 0x1290;
    pub const m_flSlopeDropOffset: usize = 0x129C;
    pub const m_flSlopeDropHeight: usize = 0x12A0;
    pub const m_vHeadConstraintOffset: usize = 0x12A4;
    pub const m_iLastWeaponFireUsercmd: usize = 0x12B8;
    pub const m_angEyeAngles: usize = 0x12BC;
    pub const m_bVCollisionInitted: usize = 0x12C8;
    pub const m_storedSpawnPosition: usize = 0x12CC;
    pub const m_storedSpawnAngle: usize = 0x12D8;
    pub const m_bIsSpawning: usize = 0x12E4;
    pub const m_bHideTargetID: usize = 0x12E5;
    pub const m_nNumDangerZoneDamageHits: usize = 0x12E8;
    pub const m_bHud_MiniScoreHidden: usize = 0x12EC;
    pub const m_bHud_RadarHidden: usize = 0x12ED;
    pub const m_nLastKillerIndex: usize = 0x12F0;
    pub const m_nLastConcurrentKilled: usize = 0x12F4;
    pub const m_nDeathCamMusic: usize = 0x12F8;
    pub const m_iAddonBits: usize = 0x12FC;
    pub const m_iPrimaryAddon: usize = 0x1300;
    pub const m_iSecondaryAddon: usize = 0x1304;
    pub const m_currentDeafnessFilter: usize = 0x1308;
    pub const m_NumEnemiesKilledThisSpawn: usize = 0x130C;
    pub const m_NumEnemiesKilledThisRound: usize = 0x1310;
    pub const m_NumEnemiesAtRoundStart: usize = 0x1314;
    pub const m_wasNotKilledNaturally: usize = 0x1318;
    pub const m_vecPlayerPatchEconIndices: usize = 0x131C;
    pub const m_iDeathFlags: usize = 0x1330;
    pub const m_hPet: usize = 0x1334;
    pub const m_unCurrentEquipmentValue: usize = 0x1500;
    pub const m_unRoundStartEquipmentValue: usize = 0x1502;
    pub const m_unFreezetimeEndEquipmentValue: usize = 0x1504;
    pub const m_nSurvivalTeamNumber: usize = 0x1508;
    pub const m_bHasDeathInfo: usize = 0x150C;
    pub const m_flDeathInfoTime: usize = 0x1510;
    pub const m_vecDeathInfoOrigin: usize = 0x1514;
    pub const m_bKilledByHeadshot: usize = 0x1520;
    pub const m_LastHitBox: usize = 0x1524;
    pub const m_LastHealth: usize = 0x1528;
    pub const m_flLastCollisionCeiling: usize = 0x152C;
    pub const m_flLastCollisionCeilingChangeTime: usize = 0x1530;
    pub const m_pBot: usize = 0x1538;
    pub const m_bBotAllowActive: usize = 0x1540;
    pub const m_bCommittingSuicideOnTeamChange: usize = 0x1541;
}
...
pub mod CSAdditionalMatchStats_t {
    ...
    pub const m_iNumSuicides: usize = 0x38;
    pub const m_iNumTeamKills: usize = 0x3C;
    pub const m_iTeamDamage: usize = 0x40;
}
