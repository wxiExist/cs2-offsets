...
public static class CCSGameRules {
    ...
    public const nint m_bSkipNextServerPerfSample = 0x27B8;
}
...
public static class CCSPlayerController {
    ...
    public const nint m_iRoundsWon = 0x824;
    ...
    public const nint m_bJustDidTeamKill = 0xF908;
    public const nint m_bPunishForTeamKill = 0xF909;
    public const nint m_bGaveTeamDamageWarning = 0xF90A;
    public const nint m_bGaveTeamDamageWarningThisRound = 0xF90B;
    public const nint m_LastTeamDamageWarningTime = 0xF90C;
}
...
public static class CCSPlayerPawn {
    ...
    public const nint m_xLastHeadBoneTransform = 0x1C10;
    public const nint m_bLastHeadBoneTransformIsValid = 0x1C30;
    public const nint m_lastLandTime = 0x1C34;
    public const nint m_iPlayerLocked = 0x1C38;
    public const nint m_flTimeOfLastInjury = 0x1C40;
    public const nint m_flNextSprayDecalTime = 0x1C44;
    public const nint m_bNextSprayDecalTimeExpedited = 0x1C48;
    public const nint m_nRagdollDamageBone = 0x1C4C;
    public const nint m_vRagdollDamageForce = 0x1C50;
    public const nint m_vRagdollDamagePosition = 0x1C5C;
    public const nint m_szRagdollDamageWeaponName = 0x1C68;
    public const nint m_bRagdollDamageHeadshot = 0x1CA8;
    public const nint m_EconGloves = 0x1CB0;
    public const nint m_qDeathEyeAngles = 0x1F28;
    public const nint m_bSkipOneHeadConstraintUpdate = 0x1F34;
}
