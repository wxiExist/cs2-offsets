...
namespace CCSPlayerController {
    ...
    constexpr std::ptrdiff_t m_iRoundsWon = 0x824;
    ...
    constexpr std::ptrdiff_t m_bJustDidTeamKill = 0xF908;
    constexpr std::ptrdiff_t m_bPunishForTeamKill = 0xF909;
    constexpr std::ptrdiff_t m_bGaveTeamDamageWarning = 0xF90A;
    constexpr std::ptrdiff_t m_bGaveTeamDamageWarningThisRound = 0xF90B;
    constexpr std::ptrdiff_t m_LastTeamDamageWarningTime = 0xF90C;
}
...
namespace CCSPlayerPawn {
    constexpr std::ptrdiff_t m_pBulletServices = 0x1548;
    constexpr std::ptrdiff_t m_pHostageServices = 0x1550;
    constexpr std::ptrdiff_t m_pBuyServices = 0x1558;
    constexpr std::ptrdiff_t m_pActionTrackingServices = 0x1560;
    constexpr std::ptrdiff_t m_pRadioServices = 0x1568;
    constexpr std::ptrdiff_t m_pDamageReactServices = 0x1570;
    constexpr std::ptrdiff_t m_nCharacterDefIndex = 0x1578;
    constexpr std::ptrdiff_t m_hPreviousModel = 0x1580;
    constexpr std::ptrdiff_t m_bHasFemaleVoice = 0x1588;
    constexpr std::ptrdiff_t m_strVOPrefix = 0x1590;
    constexpr std::ptrdiff_t m_szLastPlaceName = 0x1598;
    constexpr std::ptrdiff_t m_bInBuyZone = 0x1658;
    constexpr std::ptrdiff_t m_bWasInBuyZone = 0x1659;
    constexpr std::ptrdiff_t m_bInHostageRescueZone = 0x165A;
    constexpr std::ptrdiff_t m_bInBombZone = 0x165B;
    constexpr std::ptrdiff_t m_bWasInHostageRescueZone = 0x165C;
    constexpr std::ptrdiff_t m_iRetakesOffering = 0x1660;
    constexpr std::ptrdiff_t m_iRetakesOfferingCard = 0x1664;
    constexpr std::ptrdiff_t m_bRetakesHasDefuseKit = 0x1668;
    constexpr std::ptrdiff_t m_bRetakesMVPLastRound = 0x1669;
    constexpr std::ptrdiff_t m_iRetakesMVPBoostItem = 0x166C;
    constexpr std::ptrdiff_t m_RetakesMVPBoostExtraUtility = 0x1670;
    constexpr std::ptrdiff_t m_flHealthShotBoostExpirationTime = 0x1674;
    constexpr std::ptrdiff_t m_flLandseconds = 0x1678;
    constexpr std::ptrdiff_t m_aimPunchAngle = 0x167C;
    constexpr std::ptrdiff_t m_aimPunchAngleVel = 0x1688;
    constexpr std::ptrdiff_t m_aimPunchTickBase = 0x1694;
    constexpr std::ptrdiff_t m_aimPunchTickFraction = 0x1698;
    constexpr std::ptrdiff_t m_aimPunchCache = 0x16A0;
    constexpr std::ptrdiff_t m_bIsBuyMenuOpen = 0x16B8;
    constexpr std::ptrdiff_t m_xLastHeadBoneTransform = 0x1C10;
    constexpr std::ptrdiff_t m_bLastHeadBoneTransformIsValid = 0x1C30;
    constexpr std::ptrdiff_t m_lastLandTime = 0x1C34;
    constexpr std::ptrdiff_t m_iPlayerLocked = 0x1C38;
    constexpr std::ptrdiff_t m_flTimeOfLastInjury = 0x1C40;
    constexpr std::ptrdiff_t m_flNextSprayDecalTime = 0x1C44;
    constexpr std::ptrdiff_t m_bNextSprayDecalTimeExpedited = 0x1C48;
    constexpr std::ptrdiff_t m_nRagdollDamageBone = 0x1C4C;
    constexpr std::ptrdiff_t m_vRagdollDamageForce = 0x1C50;
    constexpr std::ptrdiff_t m_vRagdollDamagePosition = 0x1C5C;
    constexpr std::ptrdiff_t m_szRagdollDamageWeaponName = 0x1C68;
    constexpr std::ptrdiff_t m_bRagdollDamageHeadshot = 0x1CA8;
    constexpr std::ptrdiff_t m_EconGloves = 0x1CB0;
    constexpr std::ptrdiff_t m_qDeathEyeAngles = 0x1F28;
    constexpr std::ptrdiff_t m_bSkipOneHeadConstraintUpdate = 0x1F34;
}
...
namespace CCSPlayerPawnBase {
    ...
    constexpr std::ptrdiff_t m_bInvalidSteamLogonDelayed = 0xD44;
    constexpr std::ptrdiff_t m_flLastAction = 0xD48;
    constexpr std::ptrdiff_t m_flNameChangeHistory = 0xD4C;
    constexpr std::ptrdiff_t m_fLastGivenDefuserTime = 0xD60;
    constexpr std::ptrdiff_t m_fLastGivenBombTime = 0xD64;
    constexpr std::ptrdiff_t m_bHasNightVision = 0xD68;
    constexpr std::ptrdiff_t m_bNightVisionOn = 0xD69;
    constexpr std::ptrdiff_t m_fNextRadarUpdateTime = 0xD6C;
    constexpr std::ptrdiff_t m_flLastMoneyUpdateTime = 0xD70;
    constexpr std::ptrdiff_t m_MenuStringBuffer = 0xD74;
    constexpr std::ptrdiff_t m_fIntroCamTime = 0x1174;
    constexpr std::ptrdiff_t m_nMyCollisionGroup = 0x1178;
    constexpr std::ptrdiff_t m_bInNoDefuseArea = 0x117C;
    constexpr std::ptrdiff_t m_bKilledByTaser = 0x117D;
    constexpr std::ptrdiff_t m_iMoveState = 0x1180;
    constexpr std::ptrdiff_t m_grenadeParameterStashTime = 0x1184;
    constexpr std::ptrdiff_t m_bGrenadeParametersStashed = 0x1188;
    constexpr std::ptrdiff_t m_angStashedShootAngles = 0x118C;
    constexpr std::ptrdiff_t m_vecStashedGrenadeThrowPosition = 0x1198;
    constexpr std::ptrdiff_t m_vecStashedVelocity = 0x11A4;
    constexpr std::ptrdiff_t m_angShootAngleHistory = 0x11B0;
    constexpr std::ptrdiff_t m_vecThrowPositionHistory = 0x11C8;
    constexpr std::ptrdiff_t m_vecVelocityHistory = 0x11E0;
    constexpr std::ptrdiff_t m_bDiedAirborne = 0x11F8;
    constexpr std::ptrdiff_t m_iBombSiteIndex = 0x11FC;
    constexpr std::ptrdiff_t m_nWhichBombZone = 0x1200;
    constexpr std::ptrdiff_t m_bInBombZoneTrigger = 0x1204;
    constexpr std::ptrdiff_t m_bWasInBombZoneTrigger = 0x1205;
    constexpr std::ptrdiff_t m_iDirection = 0x1208;
    constexpr std::ptrdiff_t m_iShotsFired = 0x120C;
    constexpr std::ptrdiff_t m_ArmorValue = 0x1210;
    constexpr std::ptrdiff_t m_flFlinchStack = 0x1214;
    constexpr std::ptrdiff_t m_flVelocityModifier = 0x1218;
    constexpr std::ptrdiff_t m_flHitHeading = 0x121C;
    constexpr std::ptrdiff_t m_nHitBodyPart = 0x1220;
    constexpr std::ptrdiff_t m_iHostagesKilled = 0x1224;
    constexpr std::ptrdiff_t m_vecTotalBulletForce = 0x1228;
    constexpr std::ptrdiff_t m_flFlashDuration = 0x1234;
    constexpr std::ptrdiff_t m_flFlashMaxAlpha = 0x1238;
    constexpr std::ptrdiff_t m_flProgressBarStartTime = 0x123C;
    constexpr std::ptrdiff_t m_iProgressBarDuration = 0x1240;
    constexpr std::ptrdiff_t m_bWaitForNoAttack = 0x1244;
    constexpr std::ptrdiff_t m_flLowerBodyYawTarget = 0x1248;
    constexpr std::ptrdiff_t m_bStrafing = 0x124C;
    constexpr std::ptrdiff_t m_lastStandingPos = 0x1250;
    constexpr std::ptrdiff_t m_ignoreLadderJumpTime = 0x125C;
    constexpr std::ptrdiff_t m_ladderSurpressionTimer = 0x1260;
    constexpr std::ptrdiff_t m_lastLadderNormal = 0x1278;
    constexpr std::ptrdiff_t m_lastLadderPos = 0x1284;
    constexpr std::ptrdiff_t m_thirdPersonHeading = 0x1290;
    constexpr std::ptrdiff_t m_flSlopeDropOffset = 0x129C;
    constexpr std::ptrdiff_t m_flSlopeDropHeight = 0x12A0;
    constexpr std::ptrdiff_t m_vHeadConstraintOffset = 0x12A4;
    constexpr std::ptrdiff_t m_iLastWeaponFireUsercmd = 0x12B8;
    constexpr std::ptrdiff_t m_angEyeAngles = 0x12BC;
    constexpr std::ptrdiff_t m_bVCollisionInitted = 0x12C8;
    constexpr std::ptrdiff_t m_storedSpawnPosition = 0x12CC;
    constexpr std::ptrdiff_t m_storedSpawnAngle = 0x12D8;
    constexpr std::ptrdiff_t m_bIsSpawning = 0x12E4;
    constexpr std::ptrdiff_t m_bHideTargetID = 0x12E5;
    constexpr std::ptrdiff_t m_nNumDangerZoneDamageHits = 0x12E8;
    constexpr std::ptrdiff_t m_bHud_MiniScoreHidden = 0x12EC;
    constexpr std::ptrdiff_t m_bHud_RadarHidden = 0x12ED;
    constexpr std::ptrdiff_t m_nLastKillerIndex = 0x12F0;
    constexpr std::ptrdiff_t m_nLastConcurrentKilled = 0x12F4;
    constexpr std::ptrdiff_t m_nDeathCamMusic = 0x12F8;
    constexpr std::ptrdiff_t m_iAddonBits = 0x12FC;
    constexpr std::ptrdiff_t m_iPrimaryAddon = 0x1300;
    constexpr std::ptrdiff_t m_iSecondaryAddon = 0x1304;
    constexpr std::ptrdiff_t m_currentDeafnessFilter = 0x1308;
    constexpr std::ptrdiff_t m_NumEnemiesKilledThisSpawn = 0x130C;
    constexpr std::ptrdiff_t m_NumEnemiesKilledThisRound = 0x1310;
    constexpr std::ptrdiff_t m_NumEnemiesAtRoundStart = 0x1314;
    constexpr std::ptrdiff_t m_wasNotKilledNaturally = 0x1318;
    constexpr std::ptrdiff_t m_vecPlayerPatchEconIndices = 0x131C;
    constexpr std::ptrdiff_t m_iDeathFlags = 0x1330;
    constexpr std::ptrdiff_t m_hPet = 0x1334;
    constexpr std::ptrdiff_t m_unCurrentEquipmentValue = 0x1500;
    constexpr std::ptrdiff_t m_unRoundStartEquipmentValue = 0x1502;
    constexpr std::ptrdiff_t m_unFreezetimeEndEquipmentValue = 0x1504;
    constexpr std::ptrdiff_t m_nSurvivalTeamNumber = 0x1508;
    constexpr std::ptrdiff_t m_bHasDeathInfo = 0x150C;
    constexpr std::ptrdiff_t m_flDeathInfoTime = 0x1510;
    constexpr std::ptrdiff_t m_vecDeathInfoOrigin = 0x1514;
    constexpr std::ptrdiff_t m_bKilledByHeadshot = 0x1520;
    constexpr std::ptrdiff_t m_LastHitBox = 0x1524;
    constexpr std::ptrdiff_t m_LastHealth = 0x1528;
    constexpr std::ptrdiff_t m_flLastCollisionCeiling = 0x152C;
    constexpr std::ptrdiff_t m_flLastCollisionCeilingChangeTime = 0x1530;
    constexpr std::ptrdiff_t m_pBot = 0x1538;
    constexpr std::ptrdiff_t m_bBotAllowActive = 0x1540;
    constexpr std::ptrdiff_t m_bCommittingSuicideOnTeamChange = 0x1541;
}
...
namespace CSAdditionalMatchStats_t {
    ...
    constexpr std::ptrdiff_t m_iNumSuicides = 0x38;
    constexpr std::ptrdiff_t m_iNumTeamKills = 0x3C;
    constexpr std::ptrdiff_t m_iTeamDamage = 0x40;
}
